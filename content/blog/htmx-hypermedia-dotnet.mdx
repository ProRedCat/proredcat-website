...
<div className="w-full flex flex-col justify-center items-center">
    <Image src="/blog/htmx-hypermedia-dotnet/theo-t3-htmx-react.png" width={480} height={188} alt="Theo Browne video screenshot" />
...
For example, if we want a value to change in real time in two places (without requesting a partial **every** time), we have to use `document.querySelector` everywhere. This gets messy **very** quickly, and you’ll often find yourself running into null references because some HTML wasn’t there when you expected it to be.
