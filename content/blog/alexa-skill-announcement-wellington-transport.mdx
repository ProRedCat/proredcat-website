...
<div className="flex flex-wrap justify-center">
    <Image src="/blog/alexa-skill-announcement-wellington-transport/bus_stop_saved.jpg" width={240} height={240} className="m-4" />
    <Image src="/blog/alexa-skill-announcement-wellington-transport/next_bus.jpg" width={240} height={240} className="m-4" />
    <Image src="/blog/alexa-skill-announcement-wellington-transport/train_station_saved.jpg" width={240} height={240} className="m-4" />
    <Image src="/blog/alexa-skill-announcement-wellington-transport/next_train.jpg" width={240} height={240} className="m-4" />
</div>
