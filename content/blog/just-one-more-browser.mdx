...
AI has the potential to be one of the most disruptive technologies of our time, and the browser is likely to become one of its biggest distribution layers. That dynamic opens the door for both new players like [Dia](https://www.diabrowser.com/) and https://openai.com/index/introducing-chatgpt-atlas/, as well as entrenched incumbents such as Google and Microsoft who already control major entry points. But today’s browser-based AI is still early in the cycle. They’re mostly question-answer copilots sitting beside your tabs, not systems that take meaningful action.
...
<Image src="/blog/just-one-more-browser/arc-screenshot.png" width={800} height={0} />
...
### **Zen - the closest spiritual successor, but not the successor I needed**
...
<Image src="/blog/just-one-more-browser/zen-screenshot.png" width={800} height={0} />
...
### **Dia - the closest thing to Arc’s ideas, but not Arc’s experience**
...
<Image src="/blog/just-one-more-browser/dia-screenshot.png" width={800} height={0} />
